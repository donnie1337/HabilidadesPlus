...
public final class SkillCatalog {
    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case PESCA -> d("Pesque com técnica e encontre tesouros nas águas.", implemented("Isca de Sorte",5,Material.FISHING_ROD,"Aumenta a chance de transformar uma captura comum em um tesouro."),implemented("Linha Firme",30,Material.TRIPWIRE_HOOK,"Chance de preservar a durabilidade da vara ao pescar."),implemented("Maré Generosa",75,Material.HEART_OF_SEA,"Chance de receber uma captura adicional."));
