...
public final class SkillCatalog {
    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            case MINERACAO -> d("Extraia recursos das profundezas com eficiência e precisão.", p("Veio Farto",5,Material.COAL_ORE,"Pequena chance de receber um minério extra."),active("Super Quebrador",10,Material.DIAMOND_PICKAXE,"Aumenta a eficiência de mineração por um período progressivo conforme o nível de Mineração."),p("Picareta Sísmica",20,Material.IRON_PICKAXE,"Quebra blocos minerais próximos em uma linha."),p("Olhar do Geólogo",50,Material.SPYGLASS,"Destaca minérios próximos por alguns segundos."));
