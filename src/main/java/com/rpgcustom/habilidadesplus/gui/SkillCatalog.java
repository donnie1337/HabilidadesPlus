    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case LENHADOR -> d("Domine a madeira e cuide da floresta enquanto colhe.",
                    ...
                    implemented("Crítico do Lenhador",500,Material.DIAMOND,"No nível 500: 0,15% de chance de receber um recurso raro. Aumenta +0,05 ponto percentual a cada 100 níveis, até 0,40% no nível 1000."),
                    implemented("Combo de Corte",150,Material.GOLDEN_AXE,"Cortar árvores completas consecutivamente ativa estágios de combo. Cada estágio adiciona +5% de XP, até +20%."),
