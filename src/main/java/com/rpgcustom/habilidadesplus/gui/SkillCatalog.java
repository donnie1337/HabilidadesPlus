...
public final class SkillCatalog {
    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            case MINERACAO -> d("Extraia recursos das profundezas com eficiência e precisão.", p("Veio Farto",1,Material.COAL_ORE,"Chance de dobrar o drop de minérios ao minerar. Aumenta 0,1% por nível de Mineração."), active("Super Quebrador",10,Material.DIAMOND_PICKAXE,"Aumenta a eficiência de mineração por um período progressivo conforme o nível de Mineração. No nível 100+, também pode triplicar o drop."), p("Mineração Precisa",75,Material.IRON_PICKAXE,"Chance de preservar a durabilidade da picareta ao minerar."), p("Prospector",200,Material.GOLD_ORE,"Aumenta a chance de encontrar recursos e minérios raros ao minerar."));
