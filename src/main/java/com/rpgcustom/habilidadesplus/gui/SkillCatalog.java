    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case LENHADOR -> d("Domine a madeira e cuide da floresta enquanto colhe.",
                    ...
                    implemented("Replantio Automático",100,Material.OAK_SAPLING,"Passiva: ao derrubar uma árvore completa, chance de replantar automaticamente a muda correspondente. A chance cresce com o nível, chegando a 100% no nível 1000."));
