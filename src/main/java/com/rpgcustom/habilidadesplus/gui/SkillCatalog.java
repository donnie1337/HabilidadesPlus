...
public final class SkillCatalog {
    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case PESCA -> d("Pesque com técnica e encontre tesouros nas águas.", implemented("Isca de Sorte",5,Material.FISHING_ROD,"Aumenta a chance de encontrar tesouros, incluindo armaduras encantadas e itens raros."),implemented("Linha Firme",30,Material.TRIPWIRE_HOOK,"Chance de preservar a durabilidade da vara ao pescar."),implemented("Maré Generosa",75,Material.HEART_OF_THE_SEA,"Chance de receber uma captura adicional."));
            ...
            case FUNDICAO -> d("Aprimore fornalhas e aproveite melhor cada recurso fundido.", implemented("Brasa Eficiente",25,Material.COAL,"Aumenta progressivamente o tempo de queima de cada combustível."),implemented("Liga Refinada",75,Material.IRON_INGOT,"Chance progressiva de receber um item fundido extra."),implemented("Forja Acelerada",100,Material.FURNACE,"Reduz progressivamente o tempo necessário para fundir cada item."),implemented("Experiência Metalúrgica",125,Material.EXPERIENCE_BOTTLE,"Aumenta o XP recebido por itens fundidos, sem duplicar drops."),implemented("Recuperação de Combustível",150,Material.COAL,"Pequena chance de recuperar carvão, carvão vegetal ou blocos de carvão usados na fundição."));
            ...
            case ACROBACIA -> d("Movimente-se com agilidade e sobreviva a quedas perigosas.", active("Rolamento",10,Material.LEATHER_BOOTS,"Chance de anular totalmente o dano de queda."),p("Esquiva",75,Material.RABBIT_FOOT,"Chance de reduzir pela metade um ataque recebido."));
            case DESARMADO -> d("Use os punhos para controlar inimigos e sobreviver ao combate.", p("Punho de Pedra",10,Material.TURTLE_HELMET,"Aumenta levemente o dano desarmado."),p("Desvio Rápido",75,Material.IRON_NUGGET,"Chance de empurrar o inimigo ao atacar."));
