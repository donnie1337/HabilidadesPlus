    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case LENHADOR -> d("Domine a madeira e cuide da floresta enquanto colhe.",
                    implemented("Double Drop",1,Material.OAK_LOG,"Chance de receber madeira adicional ao cortar troncos; a chance aumenta com o nível."),
                    ...
                    implemented("Machado Reforçado",1,Material.DIAMOND_AXE,"Passiva de durabilidade: chance de preservar o desgaste do machado ao usá-lo, aumentando com o nível."),
                    implemented("Colheita Eficiente",100,Material.NETHERITE_AXE,"Aprimora a preservação do machado conforme a progressão do Lenhador."),
                    implemented("Crítico do Lenhador",500,Material.DIAMOND,"A partir do nível 500, troncos podem render minérios raros como diamante, esmeralda, ouro e outros."));
