    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case LENHADOR -> d("Domine a madeira e cuide da floresta enquanto colhe.",
                    ...
                    implemented("Tree Feller",25,Material.IRON_AXE,"Derruba os troncos conectados da árvore de uma vez e ativa o Leaf Cutter: as folhas desaparecem progressivamente conforme o nível. Segure SHIFT para cortar tronco por tronco."),
