...
public final class SkillCatalog {
    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            case MINERACAO -> d("Extraia recursos das profundezas com eficiência e precisão.", p("Veio Farto",1,Material.COAL_ORE,"Chance de dobrar o drop de minérios ao minerar. Aumenta 0,1% por nível de Mineração."),active("Super Quebrador",10,Material.DIAMOND_PICKAXE,"Aumenta a eficiência de mineração por um período progressivo conforme o nível de Mineração. Durante o Super Quebrador, o drop pode ser triplicado."),p("Mineração Precisa",75,Material.IRON_PICKAXE,"Chance de preservar a durabilidade da picareta ao minerar."),p("Picareta Sísmica",20,Material.IRON_PICKAXE,"Quebra blocos minerais próximos em uma linha."),p("Olhar do Geólogo",50,Material.SPYGLASS,"Destaca minérios próximos por alguns segundos."));
            case LENHADOR -> d("Domine a madeira e cuide da floresta enquanto colhe.", p("Corte Limpo",5,Material.IRON_AXE,"Chance de obter madeira adicional."),p("Queda Direcionada",25,Material.OAK_LOG,"Derruba uma parte da árvore de uma vez."),p("Muda Guardada",60,Material.OAK_SAPLING,"Chance de replantar a muda automaticamente."));
            ...
            case LANCAS -> d("Use alcance e investidas para dominar o combate.", p("Estocada Firme",5,Material.TRIDENT,"Aumenta o dano em ataques de lança."),p("Passo de Investida",35,Material.FEATHER,"Golpes em movimento causam dano adicional."));
        };
    }
