...
public final class SkillCatalog {
    ...
    public static Definition definition(SkillType skill) {
        return switch (skill) {
            ...
            case FUNDICAO -> d("Aprimore fornalhas e aproveite melhor cada recurso fundido.", p("Brasa Eficiente",25,Material.COAL,"Pequena economia de combustível."),p("Liga Refinada",75,Material.IRON_INGOT,"Chance de receber um item fundido extra."),p("Forja Acelerada",100,Material.FURNACE,"Aumenta a velocidade de fundição."));
